...
async function step(ctx) {
    ...
    const adminUser = await (0, prompt_1.promptText)('Admin username:', 'intent_admin_api');
    const adminPass = await (0, prompt_1.promptPassword)('Admin password:', () => true);
    const testerUser = await (0, prompt_1.promptText)('Tester username:', 'intent_test_user');
    const testerPass = await (0, prompt_1.promptPassword)('Tester password:', () => true);
