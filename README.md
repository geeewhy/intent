...
| **Tenant isolation by default**             | Tenant IDs propagate edge → infra → core. Row isolation in Store+Projections and namespaced workflows prevent accidental cross-tenant access or leaks. <br/><sub>[See what, why and how it is implemented in Intent](docs/architecture/multi-tenancy.md)</sub>                                                           |
