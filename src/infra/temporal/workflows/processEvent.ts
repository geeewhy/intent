...
const WORKFLOW_TTL = 60000; // 1 minute
...
export async function processEvent(
    ...
    await condition(() => eventExecuted && Date.now() - lastActivityTime > WORKFLOW_TTL);
    console.log(`[processEvent] Workflow TTL expired after ${WORKFLOW_TTL}ms of inactivity`);
}