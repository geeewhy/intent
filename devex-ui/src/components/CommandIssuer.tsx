                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                {isLoadingRegistry ? (
                                    <div
                                        className="flex items-center space-x-2 p-2 bg-slate-800 border border-slate-700 rounded">
                                        <div
                                    ...
                                    <Select value={selectedCommand} onValueChange={(value) => {
                                        ...
                                        <SelectContent className="bg-slate-800 border-slate-700">
                                            {commandRegistry.map((cmd) => (
                                                <SelectItem key={cmd.type} value={cmd.type}
                                                            className="text-slate-100 hover:bg-slate-700">
                                                    <div className="flex flex-col items-start">
                                                        <span>{cmd.type}</span>
                                                        <span
                                                            className="text-xs text-slate-400">{cmd.description}</span>
                                                    </div>
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
                            ...
                            <div className="space-y-4">
                                ...
                                <Card className="bg-slate-800 border-slate-700">
                                    <CardContent className="p-4">
                                        <Tabs value={payloadView}
                                              onValueChange={(value: "form" | "json") => setPayloadView(value)}>
                                        ...
                                        <div className="text-xs text-slate-400 mt-3">
                                            Required
                                            fields: {selectedCommandSchema.schema.required?.join(', ') || 'None'}
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
                        ...
                        {isLoadingRegistry && selectedCommand && (
                            <div
                                className="flex items-center justify-center p-8 bg-slate-800 border border-slate-700 rounded">
                                <div
                                    className="animate-spin h-5 w-5 border-2 border-blue-500 border-t-transparent rounded-full mr-3"/>
                        ...
                        <div className="space-y-2">
                            {recentCommands.map((cmd, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className="flex items-center gap-2 text-xs text-slate-300 flex-1 min-w-0">
                          ...
                          {new Date(cmd.createdAt).toLocaleString(undefined, {
                              ...
                              second: '2-digit',
                                        ...
                                        {expandedCommand === cmd.id && (
                                            <div key={`${cmd.id}-details`}
                                                 className="ml-5 p-3 bg-slate-800/50 rounded text-xs space-y-2">
                          ...
                          {new Date(cmd.createdAt).toLocaleString(undefined, {
                              ...
                              second: '2-digit',
                                                ...
                                                <div>
                                                    ...
                                                    <pre
                                                        className="text-slate-300 bg-slate-900 p-2 rounded overflow-x-auto">
